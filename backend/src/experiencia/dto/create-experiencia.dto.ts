...
export class CreateExperienciaDto {
  ...
  @Matches(/^[A-Za-zÁÉÍÓÚáéíóúÑñ0-9\s\.,\-]+$/, {
    message: 'La empresa solo puede contener letras, números, espacios, comas, puntos y guiones',
  })
  empresa: string;

  @IsNotEmpty({ message: 'El puesto es obligatorio' })
  @Matches(/^[A-Za-zÁÉÍÓÚáéíóúÑñ0-9\s\.,\-]+$/, {
    message: 'El puesto solo puede contener letras, números, espacios, comas, puntos y guiones',
  })
  puesto: string;
